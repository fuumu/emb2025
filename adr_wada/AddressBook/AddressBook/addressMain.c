...
#define DMYaddressTbl
    ...
    menuType menus[] = {
        {0, u8"データを表示", ViewFunction},
        {1, u8"追加", AddFunction},
        {2, u8"削除", DeleteFunction},
        {3, u8"編集", EditFunction},
        {4, u8"検索", SearchFunction},
        {5, u8"ソート", SortFunction},
        {6, u8"ファイル保存", SaveFunction},
        {7, u8"ファイル読み込み", LoadFunction},
        {9, u8"終了", NULL},
        { -1, NULL, NULL } // 終端を示す
    };
