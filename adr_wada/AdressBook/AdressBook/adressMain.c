...
#define DMYADRESSDAT
	...
	itemType const items[] = {
		...
		{2, "姓", 10, TYPE_STRING, offsetof(adressType, first)},
		{3, "名", 10, TYPE_STRING, offsetof(adressType, second)},
		{4, "郵便番号", 10, TYPE_STRING, offsetof(adressType, postNum)},
		{5, "住所1", 15, TYPE_STRING, offsetof(adressType, address1)},
		{6, "住所2", 15, TYPE_STRING, offsetof(adressType, address2)},
